...
<section class="about">
   ...
   <div class="content">
      <h3>why choose us?</h3>
      <p>Achieving fitness goals is not easy. Knowing how to exercise, finding time to exercise, and keeping motivated are common challenges. Getting yourself to the gym may feel much more overwhelming than actually working towards your goal. To lose weight or increase fitness levels, it’s time to try something different.</p>
      <p> Gym. can help you achieve the results you want!</p>
      <div class="icons-container">
         <div class="icons">
            <i class="fas fa-map"></i>
            <span>roadmaps to fitness</span>
         </div>
         <div class="icons">
            <i class="fas fa-hand-holding-usd"></i>
            <span> customizable & affordable prices</span>
         </div>
         <div class="icons">
